...
public class CalculateBill extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == next) {
            ...
            String q2="select month from bill where meter_no='"+meter+"'and month='"+month+"'";
            String query2 = "insert into bill values('"+meter+"', '"+month+"', '"+units+"', '"+totalbill+"', 'Not Paid')";
            String q3="update bill set units='"+units+"',totalbill= '"+totalbill+"',status= 'Not Paid' where meter_no='"+meter+"'and month='"+month+"'";
            try{
                 Conn c = new Conn();
                String t="";
                ResultSet r2 = c.s.executeQuery(q2);
                while(r2.next())
                {
                     t=r2.getString("month");
                }
                    if(t.equals(month))
                    {
                ...
                else
                    {
                       ...
                       JOptionPane.showMessageDialog(null, "Customer Bill Inserted Successfully");
                       setVisible(false);
                    }
